<template>
	<section class="relative bg-linear-to-r from-blue-600 via-blue-600 to-blue-500 pt-20 overflow-hidden">
		...
		<div class="absolute bottom-16 left-1/3 w-3 h-3 bg-blue-400 rounded-full"></div>
		...
		<div class="mx-auto relative z-10">
			<div class="grid lg:grid-cols-2 gap-12 items-center">
				...
				<div class="relative flex items-end justify-end">
					<img src="/images/ask.png" alt="Person with laptop" class="" />
				</div>
			</div>
		</div>

		<!-- Background decorative wave/shape bottom -->
		<div class="absolute bottom-0 left-0 right-0 h-32 bg-linear-to-t from-blue-700 to-transparent opacity-30"></div>
	</section>
</template>
