<template>
	<div id="home" class="min-h-screen relative overflow-hidden flex items-center">
		<!-- Background Image -->
		...
		<!-- Actual Content -->
		<section class="relative z-10 w-[90%] mx-auto px-4 sm:px-6 lg:px-8">
			<div class="flex justify-center items-center w-[70%]">
				...
				<div>
					...
					<!-- Search / Tracking Box -->
					<div class="bg-white rounded-2xl shadow-2xl p-6 flex justify-center items-center w-[100%]" v-if="layout === 'default'">
				...
				<!-- Right Empty (image now background) -->
