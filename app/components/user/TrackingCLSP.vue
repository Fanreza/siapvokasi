...
const stage1AdditionalLink = computed(() => {
	...
	const completedLogs = props.logs.filter((l: any) => l.stageNumber === 1 && l.status === "COMPLETED" && l.additionalLink);
...
const stage2AdditionalLink = computed(() => {
	...
	const completedLogs = props.logs.filter((l: any) => l.stageNumber === 2 && l.status === "COMPLETED" && l.additionalLink);
